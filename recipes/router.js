...
router.get('/viewRecipes/:userName',jsonParser,jwtAuth,(req,res) =>
{
...
//Update/Add restaurantIds
 router.put('/favorites/:id',jsonParser,(req,res) =>
  ...
  /*  console.log(req.body.userId);
    ...
    const updateRecipeIds = [];
    for(let i=0;i<req.body.restaurantInfo.length;i++)
    {
      updateRecipIds.push(req.body.recipeInfo[i]);
    }
     console.log(updateRestaurantIds);
     restaurants
    .replaceOne( {userName:req.body.userName},
                 { userName:req.body.userName,
                   recipeName: req.body.city,
                   ingredients: req.body.locationType,
                   calories: updateRestaurantIds } )
